...
Docker Desktop ou Docker Engine k3d + kubectl + Helm Ports 80 et 443 libres Ajout dans /etc/hosts (ou C:\Windows\System32\drivers\etc\hosts) : 127.0.0.1 workshop.local
...
Résultat attendu : NAME READY UP-TO-DATE AVAILABLE AGE deploy/api 2/2 2 2 2m deploy/front 2/2 2 2 2m

NAME TYPE CLUSTER-IP PORT(S) AGE svc/api ClusterIP 10.43.191.xxx 80/TCP 2m svc/front ClusterIP 10.43.132.xxx 80/TCP 2m

NAME CLASS HOSTS ADDRESS PORTS AGE ingress/web nginx workshop.local 80,443 2m
...
Résultats attendus : /front → affiche la page “Welcome to nginx / Hello from NGINX Demo” /api/get → renvoie une réponse JSON de httpbin (status 200)

Diagramme
diagramme_L7_ingress_TLS
